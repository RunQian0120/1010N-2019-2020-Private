...
Motor Roller(rollerPort, E_MOTOR_GEARSET_06, false,  E_MOTOR_ENCODER_DEGREES);

Motor Lift1(lift1Port, E_MOTOR_GEARSET_18, false, E_MOTOR_ENCODER_DEGREES);
Motor Lift2(lift2Port, E_MOTOR_GEARSET_18, true, E_MOTOR_ENCODER_DEGREES);
